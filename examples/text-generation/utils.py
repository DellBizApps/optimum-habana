...
def setup_tokenizer(args, model, assistant_model):
    ...
    if model.config.model_type == "llama":
        ...
        if assistant_model is not None:
            assistant_model.generation_config.pad_token_id = 128001
            assistant_model.generation_config.bos_token_id = 128000
            assistant_model.generation_config.eos_token_id = 128009
